...
El crédito está formado por: **Capital (La suma que solicitamos) + Interés (Lo que vamos a pagar por 
prestarnos el capital)**
...
> **Ejemplo:** Supongamos que pides un prestamo a un Banco (B1) pero este banco no tiene todo 
el capital para hacerte el prestamo. Este Banco (B1) pide prestado a un segundo banco (B2) para 
completar el capital, pero este le cobra un interés del 4 % a B1. Dado que B1 también busca ganar 
dinero, el subre un 3 % la tasa de interés y por lo tanto. Dicho prestamo te lo hace por una tasa de 
interés del 7 %. De tal manera que el gana 3 % y cubre su deuda con el banco B2. 

### Tasas de interés bajas y altas ¿qué pasa? 
| BAJA | ALTA |
|--- | --- |
| + préstamos | - préstamos |
| + baratos | + caros |
| = Mucho consumo de crédito | = Poco consumo de crédito |

## Crédito = Deuda

Ahora, tenemos a un **Prestador** que tiene esta deuda, es decir, que tiene dicho crédito que 
un **Prestatario** necesita. Por lo que para el, **dicha deuda se vuelve un Activo**. Es decir, una 
inversión, algo que va poder cobrar eventualmente. Del otro lado, para el **Prestatario/Deudor**, **se
vuelve un Pasivo**. Es decir, se vuelve un compromiso total, algo que en un momento tiene que pagar.

## ¿Por qué es tan importante el crédito? 

El gasto de uno, es el ingreso de otro. Y, si el gasto es lo que mueve a la economía. 
Entonces tenemos mucho "dinero" activando la economía.

> **Ejemplo**: Tienes un servicio, desarrollas una página web. Para ti como desarrollador o persona
que provee ese servicio, te da igual si ese ingreso económico por usar tu servicio es mediante 
un crédito o por una tarjeta de débito. Tú lo consideras un ingreso. Por lo tanto tenemos mucho
"dinero" que participa en la activación de tu económía personal. 

Recuerda que si eres buen consumidor (que cumplo con: Tener aval, tener solvencia, compromiso en 
tiempo y forma al pagar), entonces el banco me dará mejores y más créditos. 

**Esto se repite, millones de veces, con millones de personas.** Y esta estructura aplica
a empresas y gobiernos.

### Resumen de tasa de interés y la importancia del crédito 

- La tasa de interés es el costo que pagamos por utilizar dinero que no es nuestro.
- El crédito es un pasivo para el que debe y un activo para el acreedor. Es dinero que cobrará. 
- El gasto, incentiva a la economía. 
- Ese gasto, puede provenir mayormente de crédito. 

# Banco Central 

El comportamiento de la deuda, el Banco Central es un jugador sumamente decisivo para el aparente, a
veces, bienestar financiero de un país. 

Tienen un gran perso de responsabilidad, ya que ellos son quienes regulan las reglas (políticas 
monetarias) de todo un país o región. 

Que no existan fuertes inflaciones y deflaciones muy fuertes; controlar el valor. 

**Un Banco Central tiene el siguiente mandato o finalidad:**
- Cuidar el valor de la moneda nacional; que no pierda su valor, es decir, que te siga alcanzando con 
la misma cantidad de dinero, para las mismas cosas de consumo, en un cierto periodo de tiempo.

**Lo hacen con las siguientes herramientas de la política monetaria:** 
...
**Dinero en efectivo + los depósitovs bancarios (reservas)**
- Estas reservas, servirán para generar más dinero, ya que, es el dinero que prestan de un prestatario, 
o bien, lo invierte. 

> **Punto interesante:** estas reservas, están tabuladas, es decir, en teoría, los bancos solo podrán 
usar un porcentaje de estas reservas para sus propios usos.

**Los problemas comienzan cuando el banco abusa y expone las reservas a sus máximos, o cuando los 
clientes necesitan liquidez (acceder a su dinero).**

**¡Que exista dinero circulante!** Es decir, el dinero tanto digital como físico que pasa por 
nuestras manos.
...
Esta independencia está supeditada al marco legal que rige al Banco Central. Lo interesante es que 
pueden o no participar en conjunto con el gobierno federal de cada país.


### ¿Por qué el banco central nos “cuida” tanto de la inflación?

El Banco Central no desea demasiada inflación porque causa problemas. Al ver que los precios suben,
el banco sube las tasas de interés con tasas de interés más altas, menos personas pueden permitirse 
tomar préstamos y el coste de las deudas existentes sube.

Si la recesión se torna demasiado grave y la inflación ya no es un problema, el Banco Central bajará 
las tasas de interés para que todo vuelva a remontar con tasas de interés bajas
...
**Estos vaivenes forman los llamados ciclos económicos**. Los ciclos económicos tienen picos donde hay mucho ingreso, por lo tanto hay mucho gasto 
...
## 3. El ciclo de deudas a largo plazo 
 ...
 El ciclo de la deuda sigue un camino similar al de corto plazo (Solo que aquí al proceso de recuperación no se le llama **recesión**, se le llama **depresión**): se crea crédito, esto incrementa el ingreso
 porque se gasta más, al gastar más los precios de los bienes y activos financieros suben y la gente se
 siente más rica (por lo menos en papel). Cómo se siente rica, la gente pide más crédito para seguir gastando o emprendiendo y vivir felices por siempre.
 Desafortunadamente, el ciclo llega a su fin: se alcanza el punto de los pagos de las deudas son mayores que los ingresos, derivado de que el crecimiento de la deuda fue mucho mayor que el de las fuentes de
 generación de ingresos. Como los ingresos se van al pago de deudas, el gasto cae, y recordando que el gasto de uno es el ingreso de otro, el ingreso cae también. Habiendo menos ingresos, se es menos sujeto al crédito.
